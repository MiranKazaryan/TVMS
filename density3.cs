//Данный моудль представляет дочерний класс, генерирует задание по квадратичной плотности распределения с параметром
...
namespace Generators
{
    ...
    class density3 : base_density
    {
        ...
        public string task(int i)
        {
            ...
            s += "<m:mo>-</m:mo>";
            s += "<m:mn>" + alpha + "</m:mn>";
            s += "<m:msup><m:mo>)</m:mo><m:mn>2</m:mn></m:msup>";
            s += "<m:mo>,</m:mo>";
            s += "<m:mi>x</m:mi>";
            s += "<m:mo>&#8712;</m:mo>";
            s += "<m:mo>(</m:mo>";
